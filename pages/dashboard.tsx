	...
	return (
		<StandardPage title="Dashboard" description={`My personal "life" dashboard, which includes all the different stats about my online life`} url="https://lachlankemp.com/guestbook">
			<div>
				...
				<p className="text-xl mt-2 subtitle">This is my personal &quot;life&quot; dashboard, it includes all the different stats about my online life, and gives you a sneak peak too!</p>
